...
<div id="ar-wrapper">
  ...
  >
    ...
    <a-assets>
      ...
      <video
        id="video0"
        src="https://rodriged.github.io/ArtViewer/Lion-a.mp4"
        preload="auto"
      ...
      <video
        id="video1"
        src="https://rodriged.github.io/ArtViewer/FlamingPeacock.mp4"
        preload="auto"
        crossorigin="anonymous"
        playsinline
        webkit-playsinline
      ...
      <video
        id="video2"
        src="https://rodriged.github.io/ArtViewer/SS-SpanishDancer.mp4"
        preload="auto"
        crossorigin="anonymous"
        playsinline
        webkit-playsinline
      ...
      <video
        id="video3"
        src="https://rodriged.github.io/ArtViewer/IndianDancer.mp4"
        preload="auto"
        crossorigin="anonymous"
        playsinline
        webkit-playsinline
      ...
      <video
        id="video4"
        src="https://rodriged.github.io/ArtViewer/Hello-whale.mp4"
        preload="auto"
        crossorigin="anonymous"
        playsinline
        webkit-playsinline
...
<div id="videoPlayer">
  ...
  <div id="videoBottom">
    ...
    <button class="btn" onclick="backToScan()">
      Scan Another
    </button>

    <button class="btn" onclick="closeAR()">
      Exit
    </button>
...
<div id="analyticsPanel">
  ...
  <div>
    Location:
    <span id="userLocation">Unknown</span>
  </div>
...
const arWrapper =
  document.getElementById("ar-wrapper");
...
async function startAR() {
  ...
  arWrapper.style.display =
    "block";

  arScene.style.opacity =
    "1";
